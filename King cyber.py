...
logo = ("""\033[1;37m
      ...
      \033[1;37m$$ |\$$\    $$ |  $$ |\$$$ |$$ |  $$ |
      \033[1;37m$$ | \$$\ $$$$$$\ $$ | \$$ |\$$$$$$  |
      \033[1;37m\__|  \__|\______|\__|  \__| \______/ 
                                         
  ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~                                     
  Tools Create KING-CYBER
  My Github Account CYBER-404
  My Fb Group  KING CYBER-404                                                                                      
  My Id Name SIKDER OBEAYDUL
  Tools Status Random
  ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ 
""")
...
def fuck():
    ...
    os.system('clear')
    print(logo)
    print('[×] Exm: 20000 30000 50000 100000 ')
    ...
    print(' [✓] OK Ids saved as KING-OK.txt')
    print(' [✓] CP Id Save as KING-CP.txt')
    print('-------------------')
def hasan(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r[SIKDER]--[%s/%s]--[OK-%s]~[CP-%s] \r'%(loop,tl,len(oks),len(cps))),
            sys.stdout.flush()
